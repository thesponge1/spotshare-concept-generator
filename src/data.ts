    ...
    sections: [
      {
        ...
        variants: [
          ...
          },
          {
            label: 'Guest Problem',
            eyebrow: 'For Residents',
            title: 'The parking situation at your building has a fix. It\'s called SpotShare.',
            body: 'Your building has reserved spots that sit empty when residents are away. SpotShare makes those spots available to guests — temporarily, automatically, and completely free for residents.',
            bullets: [
              'No passes to print or distribute',
              'No calls to make before guests arrive',
              'Available as a link or QR code — nothing to download',
            ],
          ...
          },
          {
            ...
            body: 'SpotShare is built on a simple idea: your building already has enough parking. It just needs a smarter way to share it — temporarily, fairly, and with full resident control.',
      ...
      },
      {
        ...
        variants: [
          ...
          },
          {
            ...
            title: 'Your building already has enough parking. It just doesn\'t have a way to share it yet.',
            body: 'Reserved spots are occupied less than half the time, on average. SpotShare is the layer that lets available spots actually be available — without anyone giving up their spot permanently.',
            cta: 'Learn More',
            layoutType: 'centered',
          },
          {
            label: 'Quote',
            title: '"I had no idea my neighbor\'s spot sat empty every time she traveled. Now my guests use it."',
            body: 'That\'s SpotShare. Your spot stays yours. When you\'re not there, it helps your community. When you have guests, the same system helps you.',
      ...
      },
      {
        ...
        variants: [
          ...
          {
            label: 'For Guests',
            eyebrow: 'What your guests actually experience',
            title: 'Your guests get a link. They click it. They park. That\'s the whole experience.',
            body: 'No app to download. No account to create. No call to make. Just a link to the building\'s available spots, a one-tap claim, and a clear space waiting when they arrive.',
            cta: 'Ask Your Property Manager About SpotShare',
            layoutType: 'centered',
          },
          {
            label: 'Resident Setup',
            eyebrow: 'If you want to share your spot',
            title: 'Mark your spot available. Set the time window. Let the system do the rest.',
            body: 'Going away for a weekend? Marking your spot available takes 30 seconds. The system handles everything else — requests, confirmations, and an automatic reset when your window closes.',
            bullets: [
      ...
      },
      {
        ...
        variants: [
          ...
          },
          {
            ...
            title: 'Real-time availability. No surprises.',
            body: 'SpotShare only shows spots that are actually open. Reserved spots are only available when their residents have explicitly made them so. You\'ll never show up to find someone else in your claimed spot.',
            bullets: [
          ...
          },
          {
            ...
            eyebrow: 'Your building sets the rules',
            title: 'Every building configures SpotShare around its own parking setup and rules.',
            body: 'Your property manager decides which spots are eligible, how long guests can stay, how far in advance they can book, and everything else. SpotShare enforces those rules automatically — you just see what\'s available.',
            cta: 'Ask Your Property Manager',
            layoutType: 'highlight',
          },
        ],
      },
      {
        ...
        variants: [
          ...
          },
          {
            ...
            title: 'No app. No account. No credit card. Just parking.',
            body: 'SpotShare works from any browser on any device. Your guest gets a link, sees what\'s available, and claims a spot. That\'s the whole experience. Nothing to install, nothing to remember.',
            cta: 'Bring SpotShare to My Building',
            layoutType: 'centered',
          },
          {
            ...
            title: 'The amenity your building was missing.',
            body: 'SpotShare is included as a building amenity — same as the gym, the package room, or the bike storage. You pay nothing extra. You just benefit from a system that makes parking work the way it always should have.',
            bullets: [
      ...
      },
      {
        ...
        variants: [
          ...
          },
          {
            ...
            body: 'Share this page with your property manager or HOA board. We handle everything from there — setup, onboarding, resident communication. You just have to get it on the agenda.',
          ...
          },
          {
            ...
            body: 'Every building is different. Send us your info and we\'ll tell you honestly whether SpotShare is a good fit — and if it is, we\'ll handle reaching out to your property manager directly.',
